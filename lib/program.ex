defmodule Program do
  def load(prgm) do
    {type, code, data} = prgm
    data = [{:arg, 0, 1},{:arg, 1, 2},{:arg, 2, 3},{:arg, 3, 4}]
    #data = []
  ...
  def read_instruction_div4([head | tail], pc) do read_instruction_div4(tail, pc - 1) end

  #  data = [{:arg, 0, 1},{:arg, 1, 2},{:arg, 2, 3},{:arg, 2, 4}]
  def readM([], adress, offsett) do :null end
...
# Emulator.run({:prg, [{:addi, 1, 0, 5}, {:lw, 2, 0, :arg}, {:add, 4, 2, 1}, {:addi, 5, 0, 1}, {:sub, 4, 4, 5}, :halt], []})
